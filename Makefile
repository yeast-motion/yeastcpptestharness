...
configure:
	mkdir -p $(BUILD_DIR)
	cd $(BUILD_DIR) && cmake -DCMAKE_BUILD_TYPE=$(BUILD_TYPE) ..  -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DADDITIONAL_INCLUDE_PATHS="$(ADDITIONAL_INCLUDE_PATHS)" -DCMAKE_WARN_DEPRECATED=OFF
